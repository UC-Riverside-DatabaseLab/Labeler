...
#                if associated_users.exists():
 #                   for user in associated_users:
                            ...
                            subject_template_name="Request to Activate Your Account"#'registration/password_reset_subject.txt' 
  ...
  #              return result
   #         messages.error(request, 'Invalid Input')
    #        return self.form_invalid(form)
	     ...
	     #return redirect('http://0.0.0.0:8000/account/login')
...
class PasswordResetConfirmView(FormView):
	...
	success_url = reverse_lazy('account:login')#password_reset_success') #'/account/login'
